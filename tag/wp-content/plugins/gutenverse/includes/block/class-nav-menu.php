...
class Nav_Menu extends Block_Abstract {
	...
	public function render_content() {
		...
		return '<div id="' . $element_id . '" class="guten-element guten-nav-menu nav-menu break-point-' . $menu_breakpoint . ' ' . $submenu_click . $display_classes . '" data-item-indicator="' . $item_indicator . '">
